      ...
      children: (
        <div className="pt-4 space-y-2">
          <Form.Item name="appearance" label="外观">
            <Input.TextArea rows={2} placeholder="发色、瞳色、服装等..." />
          </Form.Item>
          <Form.Item name="personality" label="性格">
            <Input.TextArea rows={2} placeholder="性格特征..." />
          </Form.Item>
          <Form.Item name="background" label="背景">
            <Input.TextArea rows={4} placeholder="人物小传..." />
          </Form.Item>
          <Form.Item name="abilities" label="能力">
            <Input.TextArea rows={2} placeholder="特殊能力、技能..." />
          </Form.Item>
          <Form.Item name="faction" label="阵营">
            <Input placeholder="所属组织或阵营..." maxLength={255} />
          </Form.Item>
        </div>
      ),
    },
