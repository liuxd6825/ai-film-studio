...
export interface ImageSettingCardProps {
...
export const ImageSettingCard = memo(function ImageSettingCard({
  ...
  const currentLabel = `${aspectRatioValue} , ${currentResolutionLabel}`;

  return (
    <div data-image-setting-card="true" className="relative">
      <button
        ref={triggerRef}
        type="button"
        data-image-setting-trigger="true"
        ...
        createPortal(
          <>
            <div
              ...
              data-image-setting-overlay="true"
              className="fixed inset-0 z-[9998]"
            />
            <div
              data-image-setting-dropdown="true"
              ref={dropdownRef}
